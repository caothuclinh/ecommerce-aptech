	...
	<div class="container mt-5 pt-3">
		...
		@if(Auth::check())
			<div class="col-8 col-md-8 bg-light m-auto">
				<h3 class="text-justify text-primary text-center">thêm địa chỉ mới</h3>
					<a href="{{ route('address.index') }}" class="btn btn-outline-secondary">xem địa chỉ của bạn</a>
				<div id="content" class="mt-3">
					<form action="{{ route('address.store') }}" method="post">
							...
							<div class="form-group col-12">
								<button class="btn btn-outline-danger">thêm mới địa chỉ</button>
							</div>
						</div>
					</form>
				</div>
